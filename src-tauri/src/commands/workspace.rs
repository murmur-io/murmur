...
//! sidebar renders and its paged item reader.
//!
//! Content readers use the same visibility gate as every shipped reader.
//!
...
/// The `folders.level` value that marks a Project.
