...
const REMINDER_RUNTIME_PROBE_TASK_ID: &str = "reminders-smart-inbox-v2-final-scope2-20260729";
  ...
  try {
    ...
    if (phase === "initial") {
      ...
      for (let index = 0; index < providers.length; index += 1) {
        ...
        config.gatewayBaseUrl = fixture.proxyEndpoint;
...
mod runtime_probe {
    ...
    fn begin_provider_case(
        ...
        if config.provider_id != expected
            ...
            || config.gateway_base_url.as_str() != runtime.proxy_endpoint.as_str()
