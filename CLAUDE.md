...
6. Merge to `murmur` **via a PR, never a direct push** (`block-bash` hook); commits/PRs authored **only** by `QueaT <kgm004a@gmail.com>`, **no Claude trailers**; `gh` account = `JakubGawr`; `com.meetnotes.app` immutable.
