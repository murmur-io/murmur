...
- `.agents/skills/sync-release-copy` — when the CLAIMS change, not just the footage
- `.codex/rules/angular-zoneless.md` **T6** — why a hand-written mock defines a contract rather
  than verifying one
