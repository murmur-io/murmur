...
ENHANCED_RUNTIME_TASK_ID = "reminders-smart-inbox-v2-final-scope2-20260729"
...
def validate_task_provenance(root: Path) -> dict[str, Any]:
    ...
    head = git_head(root)
    branch = f"agent/v2/{ENHANCED_RUNTIME_TASK_ID}"
...
def main() -> int:
    ...
    outer_harness_owns_cargo_lane = (
        ...
        and "MURMUR_HARNESS_RUNTIME_DIR" in os.environ
    )
