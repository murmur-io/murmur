...
#
# WHY THIS EXISTS: prose rules in CLAUDE.md/.claude/rules are advisory — they
...
# the "hard-won release rules" in CLAUDE.md).
#
...
#    PR-merge is the ONLY sanctioned path (CLAUDE.md release rule 6). Feature-branch
...
#    11-hung-`security`-procs incident, CLAUDE.md release rule 3). Process management
...
#    comes back Invalid (CLAUDE.md release rule 2, the 2026-06-27 v0.4.0 failure).
