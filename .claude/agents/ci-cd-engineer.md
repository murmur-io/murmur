...
- **`com.meetnotes.app` is immutable**; commits/PRs are authored by the person who actually opens the PR (their own git identity and `gh` account) with **no Claude trailers**.
